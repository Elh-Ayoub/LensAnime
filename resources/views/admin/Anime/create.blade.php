...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method="POST" action="{{route('animes.create')}}" class="card p-3" enctype="multipart/form-data">
        <div class="w-100">
            ...
            <div class="card card-secondary p-2 col-5">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="year_of_release" name="year_of_release" min="1" class="form-control">
                </div>
                <div class="form-group">
